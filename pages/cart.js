      ...
      <Wrapper>
        ...
        <div className="flex flex-col lg:flex-row gap-12 py-10">
          ...
          <div className=" flex-[1]">
            ...
            {/* button start */}
            <button className="w-full py-4 rounded-full bg-black text-white text-lg font-medium transition-transform active:scale-95 mb3 hover:opacity-75 flex items-center justify-center gap-2" onClick={handlePayment}>
              Checkout
